...
import { authResponseSchema, signInSchema, type AuthResponse, type SignInValues } from '../schemas';
...
function signIn(data: SignInValues): Promise<AuthResponse> {
  return apiFetch('/auth/signin', authResponseSchema, {
    method: 'POST',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md bg-background rounded-xl shadow-sm p-8">
        ...
        <p className="text-sm text-center text-primary/60 mt-6">
